    ...
    class RandomEnemyGenerator : MBHEngine.Behaviour.Behaviour
    {
        ...
        public override void LoadContent(String fileName)
        {
            ...
            for (Int32 i = 0; i < def.mNumEnemies; i++)
            {
                ...
                enemy.pPosX = (RandomManager.pInstance.RandomNumber() % (rangeX)) + def.mConstraints.Left + 4.0f;
                enemy.pPosY = (RandomManager.pInstance.RandomNumber() % (rangeY)) + def.mConstraints.Top + 8.0f;

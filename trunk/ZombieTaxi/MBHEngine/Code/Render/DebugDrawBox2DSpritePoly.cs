...
{
    /// <summary>
    /// Implementation of the box2d debug renderer.  This version uses sprite batches for rendering making
    /// it simpler to get transform data identicle between the debug renderer and game renderer.
    /// </summary>
    public class DebugDrawBox2DSpritePoly : Box2D.XNA.DebugDraw
    {
        /// <summary>
        ...
        /// <summary>
        /// Used for rendered string data.
        /// </summary>
        public static SpriteFont _font;

        /// <summary>
        /// The string data to render.  I'm not sure what this is actually used for.
        /// </summary>
        ...
        /// Constructor.
        /// </summary>
        /// <param name="device">Needed for the poly sprite renderer.</param>
        /// <param name="batch">Needed for the poly sprite renderer.</param>
        public DebugDrawBox2DSpritePoly(GraphicsDevice device, SpriteBatch batch)
        {
        ...
        {
            mPolyRender.DrawCircle(mBatch, center, radius, color);
        }

        public override void DrawSolidCircle(Vector2 center, float radius, Vector2 axis, Color color)
        {
            //
            // NOTE: I don't currently have a way to fill in the shape!
            //
        ...
        {
            mPolyRender.DrawLine(mBatch, 1.0f, p1, p2, color);
        }
